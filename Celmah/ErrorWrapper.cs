...
internal class ErrorWrapper
{
    ...
    [XmlIgnore]
    public List<CelmahLogSqlEntry> SqlLog
    {
    ...
    [XmlIgnore]
    public List<CelmahLogParamEntry> Params
    {
    ...
    {
        private readonly ICelmahLogMessage _message;
        private readonly KeyValuePair<string, string>[]? _parameters;

        public ErrorLogMessageWrapper(ICelmahLogMessage message, KeyValuePair<string, string>[]? parameters = null)
        {
            _message = message;
