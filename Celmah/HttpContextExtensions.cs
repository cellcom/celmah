...
internal static class HttpContextExtensions
{
    ...
    public static string GetCelmahRelativeRoot(this HttpContext context)
    {
        var options = context.RequestServices.GetRequiredService<CelmahEnvironment>();
        return context.Request.PathBase.Add(options.Path);
    }

    public static string GetCelmahAbsoluteRoot(this HttpContext context)
    {
        var options = context.RequestServices.GetRequiredService<CelmahEnvironment>();
