...
public static class CelmahRedisBuilderExtensions
{
    /// <summary>
    ...
    public static void PersistToRedis(this ICelmahBuilder builder) => builder.PersistToRedis(static o => { });
    ...
    public static void PersistToRedis(this ICelmahBuilder builder, Action<RedisErrorLogOptions> configureOptions)
    {
    ...
    public static void PersistToRedis(this ICelmahBuilder builder, IConnectionMultiplexer server) => builder.PersistToRedis(server, static o => { });
    ...
    /// <param name="server">The Redis connection</param>
    /// <param name="configureOptions">Action to configure options</param>
    public static void PersistToRedis(this ICelmahBuilder builder, IConnectionMultiplexer server, Action<RedisErrorLogOptions> configureOptions)
    {
        builder.Services.Configure(configureOptions);
