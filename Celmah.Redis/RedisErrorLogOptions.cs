...
namespace Celmah.Redis;

public class RedisErrorLogOptions
{
    /// <summary>
    /// Gets or sets the key prefix used for the list of errors. By default this will use "urn:celmah:error_list:" and
    /// append the application name for the key.
    /// </summary>
    public string RedisListKeyPrefix { get; set; } = "urn:celmah:error_list:";

    /// <summary>
    /// Gets or sets the key prefix used for individual error payloads. By default this will use "urn:celmah:error:" and
    /// append the error identifier.
    /// </summary>
    public string RedisKeyPrefix { get; set; } = "urn:celmah:error:";
