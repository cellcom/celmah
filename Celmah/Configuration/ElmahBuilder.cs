...
public class CelmahBuilder : ICelmahBuilder
{
    private readonly IServiceCollection _services;

    internal CelmahBuilder(IServiceCollection services)
    {
        _services = services;
    }

    IServiceCollection ICelmahBuilder.Services => _services;
    ...
    {
        var options = provider.GetRequiredService<IOptions<CelmahOptions>>().Value;
